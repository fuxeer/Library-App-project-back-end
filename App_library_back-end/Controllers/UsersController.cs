...
namespace App_library_back_end.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<User>> GetAllUsers()
        {
            ...
            var command = connection.CreateCommand();
            command.CommandText = @"
                SELECT UserID, Name, Password, DateOfBirth, Email, PhoneNo, Address, UserType
                FROM User;
            ";
        ...
        public ActionResult<User> CreateUser(User newUser)
        {
            ...
            command.CommandText = @"
                INSERT INTO User (Name, Password, DateOfBirth, Email, PhoneNo, Address, UserType)
                VALUES ($name, $password, $dob, $email, $phone, $address, $userType);
